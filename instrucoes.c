...
char **pegar_instrucoes_do_pao_de_leite(void) {
    char **instrucoes = (char **) malloc(6 * sizeof(char *));

    instrucoes[0] = "1 - Dissolva o fermento no leite, bata todos os líquidos no liquidificador e despeje na farinha.";
    instrucoes[1] = "2 - Amasse bem até soltar da vasilha e das mãos.";
    instrucoes[2] = "3 - Deixar descansar por uma hora.";
    instrucoes[3] = "4 - Abra a massa na mesa com um pouco de farinha e corta com um copo.";
    instrucoes[4] = "5 - Enrolar e deixar crescer até dobrar de volume.";
    instrucoes[5] = "6 - Assar em forno médio, pré-aquecido.";
...
char **pegar_instrucoes_do_pao_de_batata(void) {
    ...
    instrucoes[0] = "1 - Bata todos os ingredientes no liquidificador (menos a farinha).";
